...
class ProfileTest(unittest.TestCase):
    ...
    def test_closed_and_open_resolve_exact_shas(self):
        ...
        self.assertEqual(opened["PF_LAUNCHER_SHA"], "468153809fe14fef80563ff63716efc1b12358da")
    ...
    def test_a133_7x_is_explicitly_gpu_less(self):
        ...
        self.assertEqual(args["PF_KERNEL_SHA"], "ba1e6025cf5cc236989d0a57cf777dfbb5e39f08")
