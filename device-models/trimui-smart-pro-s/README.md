...
| Lower controls | Menu centre X/Y = 29.625/7.15 mm so its outer right edge aligns with the left stick LED ring; Select and Start centres X = 155.0/163.0 mm, Y = 8.85 mm, preserving their 8 mm spacing while seating both inside the curved endcap | Owner visual review against the physical TG5050 | Medium-high |
...
| Front identity row | Y = 3.15 mm shared with the grille centres; reduced name starts at X = 108.10 mm and the four-bar motif begins at X = 134.20 mm, separating the final `S` while retaining clear space before the right grille | Owner visual review against the physical TG5050 | Medium-high |
