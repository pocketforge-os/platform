...
| Lower controls | Menu centre X/Y = 29.625/7.15 mm so its outer right edge aligns with the left stick LED ring; Select and Start centres X = 156.0/164.0 mm, Y = 8.85 mm, preserving their 8 mm spacing while seating both inside the curved endcap | Owner visual review against the physical TG5050 | Medium-high |
