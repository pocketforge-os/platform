...
| Lower controls | Y = 7.15 mm optical centre; Menu X = 29.625 mm so its outer right edge aligns with the left stick LED ring; Select X = 158.0 mm, Start X = 166.0 mm, preserving their 8 mm spacing while seating both inside the curved endcap | Owner visual review against the physical TG5050 | Medium-high |
